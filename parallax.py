...
class ParallaxSurface:
    ...
    def __init__(self):
        self.scroller = 0
        self.levels = []
    def add(self, image_path, scroll_factor, WIDTH, HEIGHT):
        ...
        try:
            ...
            message = "couldn't open or scale image:" + image_path
